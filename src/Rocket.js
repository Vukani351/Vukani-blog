                ...
                <div className=" gap-2" key={rocket.id}>
                  <div className="mx-2 grid max-w-sm rounded ">
                    ...
                    <div className="px-6 my-4">
                      <h3 className="uppercase text-left font-bold text-xl mb-2">
                        {rocket.name}
                      </h3>
                    </div>
                    <div className="px-2 text-left pt-2 pb-2">
                      <p className="uppercase font-bold block rounded-full px-3 py-1 font-semibold text-black mr-2 mb-2">
                        height: {rocket.height.feet} M
                      </p>
                      <p className="uppercase font-bold block rounded-full px-3 py-1 font-semibold text-black mr-2 mb-2">
                        weight: {getKg(rocket.mass.kg)} KG
                      </p>
                    </div>
