          ...
          <form className="flex items-center">
            ...
            <div className="relative w-full">
              ...
              <input
                ...
                value={name}
                onChange={filter}
                className="bg-gray-50 border rounded-md border-gray-300 text-gray-900 text-sm focus:ring-blue-500 focus:border-blue-500 block w-full pl-10 p-2.5  dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                placeholder="Search"
                required=""
              />
              <button
                ...
                <>
                  <div className="flex 3" key={index}>
                    ...
                    <div className="mx-2 grid overflow-hidden flex justify-items-center">
                      ...
                      <img
                        src="https://farm5.staticflickr.com/4599/38583829295_581f34dd84_b.jpg"
                        className="w-full max-w-sm rounded-lg overflow-hidden shadow-xl"
                        alt="rock1"
                      />
                      <div className="px-6 mt-8">
                        <h3 className="text-ellipsis truncate h-14 capitalize font-bold text-xl">
                          {article.title} {index}
                        </h3>
                      </div>
                      <div className="overflow-hidden px-2 mb-5">
                        <p className="text-ellipsis h-6 font-normal max-w-sm rounded-md px-3 text-xl text-black mr-2 mb-8">
                          {' '}
                          {article.details}{' '}
                        </p>
                      </div>
                      <Link
                        to={article.links.article}
                        className="w-full"
                        _target="blank"
                      >
                        <button className="uppercase mb-4 justify-self-center bg-black hover:bg-blue-700 text-white font-bold py-2 rounded w-11/12">
                          {' '}
                          view article{' '}
                        </button>
                      </Link>
